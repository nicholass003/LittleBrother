...
class AddVolumeEntityCodec implements Codec{
    ...
    public function decode(ByteBufferReader $in, CodecType $codec) : AddVolumeEntityPacket{
        ...
        $pk->minBound = CodecHelper::readSignedBlockPosition($in);
        $pk->maxBound = CodecHelper::readSignedBlockPosition($in);
    ...
    public function encode(ByteBufferWriter $out, Packet $pk, CodecType $codec) : void{
        ...
        CodecHelper::writeSignedBlockPosition($out, $pk->minBound);
        CodecHelper::writeSignedBlockPosition($out, $pk->maxBound);
